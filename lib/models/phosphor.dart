// GENERATED — Phosphor glyphs as plain const IconData.
//
// phosphor_flutter 2.1.0 subclasses IconData (now a final class), so its
// Dart API will not compile on this Flutter. We keep the package only for
// its bundled font and reference the glyphs directly here, which also keeps
// icon tree-shaking on. Regenerate if the icon set changes.
import 'package:flutter/widgets.dart';

const _pkg = 'phosphor_flutter';

/// Phosphor Regular glyphs used by the app.
abstract final class PhosphorR {
...
abstract final class PhosphorF {
  static const IconData squaresFour = IconData(
    0xe464,
